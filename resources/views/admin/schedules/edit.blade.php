...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Update class schedule information</p>
</div>
@endsection

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.schedules.update', $schedule) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text"
                       id="grade_level"
                       name="grade_level"
                       value="{{ old('grade_level', $schedule->grade_level) }}"
                       required
            ...
            <div>
                ...
                <input type="time"
                       id="start_time"
                       name="start_time"
                       value="{{ old('start_time', $schedule->start_time ? date('H:i', strtotime($schedule->start_time)) : '') }}"
                       required
            ...
            <div>
                ...
                <input type="time"
                       id="end_time"
                       name="end_time"
                       value="{{ old('end_time', $schedule->end_time ? date('H:i', strtotime($schedule->end_time)) : '') }}"
                       required
