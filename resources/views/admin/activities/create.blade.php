...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-600 mt-1">Add a new activity or event</p>
    </div>
        ...
        <form action="{{ route('admin.activities.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select name="category"
                    ...
                    <option value="Field Trip" {{ old('category') == 'Field Trip' ? 'selected' : '' }}>Field Trip</option>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer hover:border-primary-500 transition @error('post_type') border-red-500 @enderror">
                        <input type="radio" name="post_type" value="regular" {{ old('post_type', 'regular') == 'regular' ? 'checked' : '' }}
                    ...
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer hover:border-red-500 transition">
                        <input type="radio" name="post_type" value="youtube" {{ old('post_type') == 'youtube' ? 'checked' : '' }}
                               class="sr-only peer" onchange="togglePostTypeFields()">
                        <div class="flex-1 text-center">
                    ...
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer hover:border-blue-500 transition">
                        <input type="radio" name="post_type" value="facebook" {{ old('post_type') == 'facebook' ? 'checked' : '' }}
                               class="sr-only peer" onchange="togglePostTypeFields()">
                        <div class="flex-1 text-center">
            ...
            <div class="mb-6">
                ...
                <input type="date"
                    name="date_uploaded"
                    id="date_uploaded"
                    value="{{ old('date_uploaded', date('Y-m-d')) }}"
            ...
            <div class="mb-6" id="facebook_field" style="display: none;">
                ...
                <textarea
                    ...
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent font-mono text-xs @error('facebook_url') border-red-500 @enderror">{{ old('facebook_url') }}</textarea>
                @error('facebook_url')
                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0">
                        <img id="image_preview"
                            src="{{ asset('images/default-activity.png') }}"
                            alt="Preview"
            ...
            <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        <p class="font-semibold mb-1">Activity Information</p>
                        <ul class="list-disc list-inside space-y-1">
                            <li>Choose a clear, descriptive name for the activity</li>
                            <li>Select the appropriate category to help organize activities</li>
                            <li>Upload a high-quality image to showcase the activity</li>
                            <li>Set the activity date to when it occurred or will occur</li>
                        </ul>
                    </div>
                </div>
            </div>
