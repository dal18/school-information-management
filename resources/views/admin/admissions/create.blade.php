...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">Create New Admission</h1>
        <p class="text-gray-600 mt-1">Add a new admission application</p>
    </div>
...
<div class="bg-white rounded-lg shadow-md p-8">
    <form action="{{ route('admin.admissions.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <!-- Document Uploads -->
        <div class="mb-8">
            <h3 class="text-xl font-semibold text-gray-900 mb-4 pb-2 border-b">Documents (Optional)</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
        ...
        <div class="flex items-center justify-end space-x-4 pt-6 border-t">
            ...
            <button type="submit"
                ...
                <i class="fas fa-save mr-2"></i>Create Admission
            </button>
        </div>
    </form>
</div>
